...
Partial Public Class OfficeDataSet
    ...
    Partial Public Class Accounts_TblDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddAccounts_TblRow(ByVal ID As Integer, ByVal Username As String, ByVal Password As String) As Accounts_TblRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function FindByID(ByVal ID As Integer) As Accounts_TblRow
            Return CType(Me.Rows.Find(New Object() {ID}),Accounts_TblRow)
        End Function
    ...
    Partial Public Class Accounts_TblRow
        ...
        Public Property ID() As Integer
            Get
                Return CType(Me(Me.tableAccounts_Tbl.IDColumn),Integer)
            End Get
            Set
                Me(Me.tableAccounts_Tbl.IDColumn) = value
            End Set
        End Property
        ...
        Public Property Username() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Username' in table 'Accounts_Tbl' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Function IsUsernameNull() As Boolean
            Return Me.IsNull(Me.tableAccounts_Tbl.UsernameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetUsernameNull()
            Me(Me.tableAccounts_Tbl.UsernameColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace OfficeDataSetTableAdapters
    ...
    Partial Public Class Accounts_TblTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Accounts_Tbl` WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) "& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Accounts_Tbl` (`ID`, `Username`, `Password`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Accounts_Tbl` SET `ID` = ?, `Username` = ?, `Password` = ? WHERE ((`ID` ="& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Username, [Password] FROM Accounts_Tbl"
